...
@TestPropertySource(properties = [
        ...
        "aws.case-bucket-name=events",
        "aws.bucket-name-prefix=bfdev",
        "aws.credentials.access-key=accessKey",
        "aws.credentials.secret-key=secretAccessKeyo",
        "gov.notify.api.key=apiKey",
        "gov.notify.api.notification.email-template-id=8b9d08a0-c761-47da-934f-3a6476849767",
        "gov.notify.api.notification.sms-template-id=03da9771-553a-4a90-a808-649f743952b5",
